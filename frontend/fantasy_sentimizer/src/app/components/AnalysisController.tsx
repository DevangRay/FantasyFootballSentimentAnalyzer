...
export default function AnalysisController({ submittedText, setSubmittedText }: { submittedText: string; setSubmittedText: React.Dispatch<React.SetStateAction<string | null>> }) {
